  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        ...
        >
          <TransactionButton
            className="px-4 py-2 bg-green-500 text-white rounded font-semibold hover:bg-green-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed w-fit"
            text="Fund"
          />
