...
export function FundProject({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2 justify-end">
        <p className="text-sm text-gray-500 dark:text-gray-400">Need ETH?</p>
        <motion.div
        ...
        >
          <FundButton
            className="px-4 py-2 bg-blue-500 text-white rounded font-semibold hover:bg-blue-600 transition-all duration-200"
            text="Buy ETH"
            hideIcon={true}
            openIn="tab"
          />
